...
public class KejianLiuyanView extends KejianLiuyanEntity implements Serializable {
	...
	public KejianLiuyanView() {

	}

	public KejianLiuyanView(KejianLiuyanEntity kejianLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, kejianLiuyanEntity);
