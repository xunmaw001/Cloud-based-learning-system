...
public class KejianLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public KejianLiuyanEntity() {

	}

	public KejianLiuyanEntity(T t) {
		try {
    ...
    public String toString() {
        return "KejianLiuyan{" +
            ...
            ", kejianId=" + kejianId +
            ", yonghuId=" + yonghuId +
            ", kejianLiuyanContent=" + kejianLiuyanContent +
