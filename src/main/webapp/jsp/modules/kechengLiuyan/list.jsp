        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">课程信息留言管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">课程信息留言列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">课程信息留言列表</h3>
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            row.appendChild(yonghuNameCell);
                ...
                //留言内容
            var kechengLiuyanContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.kechengLiuyanContent && item.kechengLiuyanContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.kechengLiuyanContent.indexOf('<img');
                var endIndex = item.kechengLiuyanContent.indexOf('>');
                    kechengLiuyanContentCell.innerHTML = item.kechengLiuyanContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.kechengLiuyanContent != null && item.kechengLiuyanContent != "" && item.kechengLiuyanContent.length >= 11) {
                        kechengLiuyanContentCell.innerHTML = item.kechengLiuyanContent.substring(0, 10) + "...";
                } else {
                        kechengLiuyanContentCell.innerHTML = item.kechengLiuyanContent;
                }
            }
            row.appendChild(kechengLiuyanContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("kechengLiuyan/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addkechengLiuyan", "addkechengLiuyan");
            window.location.href = "add-or-update.jsp"
        }
