...
var centerMenu = [
    ...
    ,{
        name: '课程信息收藏',
        url: '../kechengCollection/list.jsp'
    }
    ,{
        name: '学习课件收藏',
        url: '../kejianCollection/list.jsp'
    }
    ,{
        name: '学习视频收藏',
        url: '../shipinCollection/list.jsp'
    }
...
var indexNav = [
    ...
    {
        name: '学习视频',
        url: './pages/shipin/list.jsp'
    },
    {
        name: '学习课件',
        url: './pages/kejian/list.jsp'
    },
    {
        name: '新闻',
...
var adminurl =  "http://localhost:8080/yuunduanxuexixitong/index.jsp";
