                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../shipin/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../shipin/detail.jsp?id='+item.id)"><span>{{item.shipinName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 shipinContent 字段去除无用字符 如果字段长度大于60  就截取到60
            shipinContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (shipinTypes != null && shipinTypes != "" && shipinTypes != "null") {
                param['shipinTypes'] = shipinTypes;
                                                    ...
                                                    // 获取列表数据
            http.request('shipin/list', 'get', param, function(res) {
