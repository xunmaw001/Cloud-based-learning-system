...
<div id="app">
    <div class="data-detail">
        <div class="data-detail-breadcrumb">
            ...
            <!-- 收藏 -->
            <a onclick="addShipinCollection()" href="javascript:void(0)">
                            ...
                            <form class="layui-form message-form" style="padding-right: 20px;border-bottom: 0;">
                                <div class="layui-form-item layui-form-text">
                                    ...
                                    <div class="layui-input-block">
                                        <textarea name="shipinLiuyanContent" id="shipinLiuyanContent" required lay-verify="required" placeholder="留言内容"
                                                  class="layui-textarea"></textarea>
                                    </div>
                                </div>
                                <div class="layui-form-item">
                                    <div class="layui-input-block">
                                        <button class="layui-btn btn-submit" lay-submit lay-filter="shipinLiuyanContent">立即提交</button>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function () {
        ...
        // 提交留言
        form.on('submit(shipinLiuyanContent)', function (data) {
            data.yonghuId = localStorage.getItem('userid');
            data.tableName = localStorage.getItem('userTable');
            data.shipinLiuyanContent =jquery("#shipinLiuyanContent").val();
