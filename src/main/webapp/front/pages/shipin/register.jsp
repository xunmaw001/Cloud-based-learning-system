              ...
              <form class="layui-form login-form" lay-filter="register">
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">视频标题:</span>
                        <div class="layui-input-inline">
                            <input type="text" name="shipinName" id="shipinName"  placeholder="视频标题"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">视频类型:</span>
                        <div class="layui-input-inline">
                            <select name="shipinTypes" id="shipinTypes" lay-filter="shipinTypes" style="width: 600px;">
