                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../kecheng/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../kecheng/detail.jsp?id='+item.id)"><span>{{item.kechengName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 kechengContent 字段去除无用字符 如果字段长度大于60  就截取到60
            kechengContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (kechengTypes != null && kechengTypes != "" && kechengTypes != "null") {
                param['kechengTypes'] = kechengTypes;
                                                            ...
                                                            // 获取列表数据
            http.request('kecheng/list', 'get', param, function(res) {
