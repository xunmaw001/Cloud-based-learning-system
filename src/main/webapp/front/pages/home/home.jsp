            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">学习课件展示</span>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  kejianList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../kejian/detail.jsp?id='+item.id)">
                                            <img :src="item.kejianPhoto?item.kejianPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.kejianName}}</p>
                                            <p style="color: red;" v-if="item.kejianNewMoney">{{item.kejianNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../kejian/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">学习视频展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  shipinList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../shipin/detail.jsp?id='+item.id)">
                                            <img :src="item.shipinPhoto?item.shipinPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.shipinName}}</p>
                                            <p style="color: red;" v-if="item.shipinNewMoney">{{item.shipinNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../shipin/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="ng-inmod-ini">
              ...
              <span class="ng-inmod-the-bg ng-inmod-the-bg-left" aos="fade-down-right">
                ...
                <img src="../../xznstatic/img/insie2.png" />
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">课程信息展示</span>
                        <span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
                    </div>
                    <span class="ng-inmod-thebor" aos="fade-up"></span>
                </div>
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="ng-incontlst-doc ng-incontlst-doc-show">
                        <div class="row">
                            <div class="ng-incontlst-col" v-for="(item,index) in  kechengList" v-bind:key="index">
                                <div class="ng-incontlst-bor">
                                    <div class="ng-incontlst-img ng-oa ng-fault">
                                        <a href="javascript:void(0);" @click="jump('../kecheng/detail.jsp?id='+item.id)">
                                            <img :src="item.kechengPhoto?item.kechengPhoto.split(',')[0]:''" width="300px" height="300px"/>
                                        </a>
                                    </div>
                                    <div class="ng-fault ng-container">
                                        <div class="ng-incontlst-tit">
                                            <p>{{item.kechengName}}</p>
                                            <p style="color: red;" v-if="item.kechengNewMoney">{{item.kechengNewMoney}} RMB</p>
                                            <span></span>
                                        </div>
                                        <a href="javascript:void(0);" class="ng-incontlst-ikk" @click="jump('../kecheng/detail.jsp?id='+item.id)">查看详情</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`kejian/list`, 'get', {
            page: 1,
            limit: 6,
            flag: 1
        }, function (res) {
            vue.kejianList = res.data.list;
        });
