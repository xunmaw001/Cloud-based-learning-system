                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../kejian/detail.jsp?id='+item.id)">
                                ...
                                <div class="ng-prslist-tit" @click="jump('../kejian/detail.jsp?id='+item.id)"><span>{{item.kejianName}}</span></div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 kejianContent 字段去除无用字符 如果字段长度大于60  就截取到60
            kejianContent: function(val) {
                if (val) {
        ...
        function pageList() {
            ...
            if (kejianTypes != null && kejianTypes != "" && kejianTypes != "null") {
                param['kejianTypes'] = kejianTypes;
                                                    ...
                                                    // 获取列表数据
            http.request('kejian/list', 'get', param, function(res) {
