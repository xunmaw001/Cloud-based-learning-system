                ...
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="kejianName" id="kejianName"  placeholder="视频标题"  lay-verify="required" autocomplete="off" class="layui-input" style="width: 600px;">
                        </div>
                    </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                    <div class="layui-inline" >
                        <span style="margin-top: 8px;float: left">课件类型:</span>
                        <div class="layui-input-inline">
                            <select name="kejianTypes" id="kejianTypes" lay-filter="kejianTypes" style="width: 600px;">
